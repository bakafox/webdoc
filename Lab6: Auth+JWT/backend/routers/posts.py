    ...
    posts = [
        {
            ...
            'body': 'Всю свою жизнь человек сталкивается со временем через изменения — '
                    ...
                    + 'неумолимо берёт верх над всем рукотворным, будь то песочный замок '
        ...
        },
        {
            ...
            'body': 'Изменение — это вообще единственный феномен, через может быть нами '
                    ...
                    + 'а значит — его возникновения и неминуемого исчезновения.'
        },
        {
            'id': 3,
            'title': 'ывыфваыфваппп'
        ...
        {
            'id': 4,
            'title': 'алиса что делать если снится какойто жёлтый летающий кот'
        },
        {
            'id': 5,
